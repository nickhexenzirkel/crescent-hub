...
const KB = [
  ...
  { k: ['musica muito longa', 'limite de duracao', 'nao deixa jogar essa musica', 'musica nao carrega no uniko wave'],
    a: 'O Uniko Wave não aceita músicas com mais de 10 minutos de duração — tenta uma versão mais curta ou outra música.' },
  // ── PRISMA STORE ──
  { k: ['ganhar prisma', 'conseguir prisma', 'como ganho prisma', 'como conseguir prisma', 'mais prisma', 'juntar prisma'],
    a: 'Você ganha prismas no CHECK-IN de segunda a sexta e completando MISSÕES (Maratona Uniko Wave, Voz ativa, Pequeno/Grande Colecionador, Top do mês de música, 1ª/2ª compra). Comum é mais fácil; Premium é o raro.' },
  ...
  { k: ['check-in', 'checkin', 'check in', 'sequencia', 'streak', 'dia do check'],
    a: 'O check-in é de segunda a sexta (5 dias), com prismas crescentes que alternam as moedas (dia 1: 70 Premium; 2: 90 Comum; 3: 120 Premium; 4: 160 Comum; 5: 200 Premium — o bônus da sexta). Sábado e domingo não contam pro ciclo nem quebram a sequência. Faltou um dia de semana, volta pro dia 1. Tem teto mensal (300 Premium / 200 Comum).' },
  { k: ['missao', 'missoes', 'desafio', 'completar missao', 'quais missoes', 'lista de missoes'],
    a: 'Missões dão prismas: Maratona Uniko Wave, Voz ativa, Pequeno/Grande Colecionador, Top do mês de música e 1ª/2ª compra. Me pergunte sobre uma missão específica (ex: "como faço a Grande Colecionador?") que eu explico certinho como completar!' },
  { k: ['maratona', 'maratona uniko wave', '20 minutos', '40 minutos', 'missao do uniko wave', 'missao uniko wave', 'jogar uniko wave por'],
    a: 'A missão Maratona pede tempo jogado no Uniko Wave NO DIA: 20 minutos = 100 Prisma Comum; 40 minutos = 10 Prisma Premium. É só jogar músicas normalmente lá — o tempo conta sozinho, sem precisar fazer nada especial.' },
  { k: ['pequeno colecionador', 'colecionador pequeno'],
    a: 'Pequeno Colecionador pede 10 Unikos na sua Coleção (dá 50 Prisma Premium). Você ganha Unikos jogando a Audição (o gacha) do Uniko Wave, comprando na Prisma Store, ou em eventos como o Capture o Uniko.' },
  { k: ['grande colecionador', 'colecionador grande'],
    a: 'Grande Colecionador pede MAIS DE 20 Unikos na sua Coleção (dá 50 Prisma Premium). Mesma forma de conseguir Unikos do Pequeno Colecionador: Audição do Uniko Wave, Prisma Store, ou eventos.' },
  { k: ['top do mes', 'top 1 do mes', 'top 2 do mes', 'top 3 do mes', 'quem mais coloca musica', 'top de musica'],
    a: 'O Top 1/2/3 do mês é de quem mais colocou música na Central Alexa no mês PASSADO (já fechado). 1º lugar = 100 Premium, 2º = 70, 3º = 50. É só colocar música normalmente na Central Alexa — quanto mais você toca, maior a chance de ficar no Top.' },
  { k: ['primeira compra', 'segunda compra', '1a compra', '2a compra'],
    a: 'As missões de compra dão prismas na sua 1ª (200 Comum) e 2ª (400 Comum) compra na Loja da Prisma Store — é só resgatar qualquer prêmio lá.' },
  ...
  { k: ['feedback', 'sugestao', 'reclamacao', 'opiniao', 'dar feedback', 'voz ativa', 'missao voz ativa'],
    a: 'Dê um feedback na aba Feedback do Portal pra registrar opinião/sugestão — isso completa a missão Voz ativa (30 Prisma Premium) e dá prismas. Não precisa ser sobre algo ruim: qualquer feedback conta.' },
  ...
  { k: ['votar pular', 'pular musica', 'votos para pular', 'quantos votos', 'skip'],
    a: 'Pra pular a música tocando na Central Alexa, precisa de 4 votos (cada pessoa só vota uma vez por música).' },
  { k: ['nao consigo adicionar musica', 'adicionar musica travado', 'espere para adicionar', 'nao deixa colocar musica'],
    a: 'Não dá pra adicionar música nos 10 segundos iniciais nem nos 10 segundos finais da música que está tocando na Central Alexa — espere passar esse intervalo e tenta de novo.' },
  { k: ['quantas musicas posso colocar', 'limite de vagas', 'vagas na fila', 'vaga ocupada'],
    a: 'Cada pessoa tem 2 "vagas" na fila da Central Alexa. Uma música normal usa 1 vaga; música com mais de 15 minutos usa as 2 de uma vez.' },
  // ── DIVERSOS ──
  { k: ['my uniko', 'colecao de uniko', 'meus unikos', 'usar como assistente', 'trocar assistente', 'assistente diferente'],
    a: 'Na Coleção de Unikos (aba My Uniko) você vê todos os Unikos que já capturou. Cada um pode virar sua FOTO DE PERFIL ou o ASSISTENTE que fica no canto da tela (botão "Usar como assistente") — os que você ainda não tem aparecem como silhueta bloqueada.' },
  { k: ['games', 'jogos arcade', 'ranking geral', 'jogos do portal', 'unikorun', 'meteor storm', 'alien invaders', 'unikoflap', 'quais jogos'],
    a: 'Na aba Games do Portal tem 4 jogos arcade: UnikoRun (corredor, desvie das rochas), Meteor Storm (desvie dos meteoros e pegue estrelas), Alien Invaders (shooter) e UnikoFlap. O Ranking Geral soma sua pontuação normalizada dos 4.' },
  { k: ['capture o uniko', 'capturar uniko', 'como capturo', 'arremessar uniko', 'pega o uniko', 'como pego o uniko que apareceu'],
    a: 'Quando um Uniko aparece (card na aba Início), arraste o assistente UNIKO (canto da tela) e solte em cima dele pra arremessar. Você tem 2 tentativas: a 1ª pode escapar, a 2ª é garantida. Só quem captura primeiro ganha — os outros só veem quem pegou.' },
  ...
  { k: ['foto de perfil', 'mudar foto', 'trocar foto', 'imagem de perfil', 'alterar foto'],
    a: 'Pra trocar sua foto de perfil: no Portal do Colaborador, aba Início, clique na sua foto/avatar pra abrir o editor — escolha a imagem em "Trocar imagem", ajuste o recorte e salve. Também dá pra usar um Uniko capturado como foto, pela Coleção de Unikos (My Uniko).' },
