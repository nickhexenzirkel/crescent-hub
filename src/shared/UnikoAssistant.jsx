...
const KB = [
  ...
  { k: ['missao', 'missoes', 'desafio', 'maratona', 'voz ativa', 'colecionador', 'completar missao'],
    a: 'Missões dão prismas: Maratona Uniko Wave (20 min/dia = 100 Comum; 40 min/dia = 10 Premium), Voz ativa (1 feedback no mês = 30 Premium), Pequeno Colecionador (10 Unikos na Coleção = 50 Premium), Grande Colecionador (mais de 10 Unikos = 50 Premium), Top 1/2/3 de quem mais coloca música (100/70/50 Premium) e 1ª/2ª compra (200/400 Comum).' },
