...
export const G = {
  ...
  finger:    <><path d="M12 11v2.5c0 2.6-.8 5-2.2 7" /><path d="M8.5 7.9A4.5 4.5 0 0116.5 11v2.5c0 1.6-.2 3.1-.6 4.5" /><path d="M5.4 16.8c.4-1 .6-2.1.6-3.3V11a6 6 0 013.1-5.3" /><path d="M13.5 5.2A6 6 0 0118 11v1" /><path d="M19.8 16.5c.1-.9.2-1.8.2-2.7" /><path d="M3.3 12.5c.2-3.4 1.8-6.4 4.2-8.3" /><path d="M11 21.5c.3-.5.6-1 .8-1.6" /></>,
