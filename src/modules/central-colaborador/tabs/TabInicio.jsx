        ...
        <Card style={{padding:'14px 18px'}}>
          <div style={{display:'flex',alignItems:'center',gap:12}}>
            ...
            <div style={{flex:1,minWidth:0}}>
              ...
              <div style={{fontSize:17,fontWeight:700,color:T.text,marginTop:2}}>{sv?`R$ ${((USER.salary||0)+(USER.salary_1k||0)-(USER.inss||0)-(USER.ir||0)).toLocaleString('pt-BR',{minimumFractionDigits:2})}`:'R$ ••••,••'}</div>
            </div>
