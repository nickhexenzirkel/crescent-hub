...
const THEMES = [
  ...
  { id: 'fazenda', nome: 'Fazenda', emoji: '🚜', words: [
    'fazenda', 'trator', 'celeiro', 'vaca', 'porco', 'galinha', 'cavalo', 'ovelha',
    'cabra', 'pato', 'ganso', 'coelho', 'fazendeiro', 'espantalho', 'silo', 'curral',
    'feno', 'milharal', 'plantação', 'arado', 'charrete', 'moinho de vento', 'cerca',
    'chiqueiro', 'galinheiro', 'estábulo', 'colheita', 'semente', 'regador', 'enxada',
    'foice', 'pá', 'carroça de feno', 'cachorro de fazenda', 'gato do celeiro', 'burro',
    'pônei', 'touro', 'bezerro', 'pintinho', 'ninho de galinha', 'ovo', 'leite',
    'queijo', 'manteiga', 'mel', 'colmeia', 'abelha', 'borboleta', 'minhoca'] },
  { id: 'espaco', nome: 'Espaço', emoji: '🚀', words: [
    'foguete', 'astronauta', 'nave espacial', 'planeta', 'lua', 'sol', 'estrela',
    'cometa', 'meteoro', 'buraco negro', 'via láctea', 'saturno', 'marte', 'terra',
    'satélite', 'telescópio', 'capacete espacial', 'alienígena', 'disco voador',
    'base lunar', 'estação espacial', 'traje espacial', 'painel de controle',
    'lançamento', 'contagem regressiva', 'órbita', 'constelação', 'nebulosa',
    'asteroide', 'sonda espacial', 'robô explorador', 'bandeira na lua',
    'pegada na lua', 'sistema solar', 'cratera', 'anel de saturno', 'cauda de cometa',
  ...
  { id: 'piratas', nome: 'Piratas', emoji: '🏴‍☠️', words: [
    'pirata', 'navio pirata', 'bandeira pirata', 'caveira', 'tesouro', 'baú do tesouro',
    'mapa do tesouro', 'ilha', 'papagaio', 'perna de pau', 'tapa-olho', 'gancho',
    'espada', 'canhão', 'âncora', 'bússola', 'luneta', 'barril', 'moeda de ouro',
    'joia', 'colar de pérolas', 'capitão pirata', 'marinheiro', 'sereia', 'kraken',
    'tubarão', 'ilha deserta', 'palmeira', 'praia', 'cofre', 'chave',
    'pegadas na areia', 'garrafa com mensagem', 'farol', 'rochedo',
    'tempestade no mar', 'ondas', 'timão', 'vela do navio', 'mastro', 'corda',
    'rede de dormir', 'remo', 'jangada', 'caverna secreta', 'x marca o lugar',
    'cicatriz', 'dente de ouro', 'rum', 'taverna'] },
  { id: 'dinossauros', nome: 'Dinossauros', emoji: '🦕', words: [
    'dinossauro', 'tiranossauro rex', 'tricerátopo', 'brontossauro', 'pterodáctilo',
    'estegossauro', 'velociraptor', 'ovo de dinossauro', 'fóssil', 'osso de dinossauro',
    'pegada de dinossauro', 'vulcão', 'meteoro', 'pré-história', 'caverna',
    'homem das cavernas', 'lança de pedra', 'fogueira', 'mamute',
    'tigre dente de sabre', 'museu de história natural', 'esqueleto de dinossauro',
    'escavação', 'paleontólogo', 'pincel de escavação', 'âmbar', 'samambaia gigante',
    'pântano pré-histórico', 'lagarto gigante', 'garra afiada', 'dente afiado',
    'cauda longa', 'chifre', 'placas nas costas', 'asas de réptil', 'ninho de dinossauro',
    'filhote de dinossauro', 'rugido', 'cometa caindo', 'terremoto', 'lava',
    'erupção vulcânica', 'réptil voador', 'dinossauro aquático', 'jipe de safári',
    'cientista', 'parque dos dinossauros', 'cerca elétrica'] },
  { id: 'circo', nome: 'Circo', emoji: '🎪', words: [
    'circo', 'palhaço', 'trapezista', 'malabarista', 'mágico', 'domador de leões',
    'leão', 'elefante de circo', 'tenda de circo', 'pipoca', 'algodão doce',
    'ingresso', 'bilheteria', 'arquibancada', 'holofote', 'monociclo', 'corda bamba',
    'rede de proteção', 'canhão humano', 'contorcionista', 'engolidor de fogo',
    'cachorro amestrado', 'cavalo de circo', 'foca amestrada', 'chapéu de mágico',
    'coelho da cartola', 'varinha mágica', 'roupa colorida', 'nariz de palhaço',
    'sapato gigante', 'buzina de palhaço', 'torta na cara', 'balão', 'pirueta',
    'cambalhota', 'escada', 'bola de equilíbrio', 'argola de fogo', 'chicote',
    'apito', 'banda circense', 'tambor', 'ingresso vip', 'tenda listrada',
    'mastro de circo', 'artista de circo', 'plateia', 'aplausos', 'bis'] },
  ...
  { id: 'praia', nome: 'Praia', emoji: '🏖️', words: [
    'guarda-sol', 'castelo de areia', 'concha', 'caranguejo', 'água de coco',
    'picolé', 'prancha de surfe', 'boia', 'onda', 'chinelo', 'óculos escuros',
    'canga', 'cadeira de praia', 'barraca', 'vôlei de praia', 'frescobol',
    'quiosque', 'milho verde', 'protetor solar', 'bronzeado', 'queimadura de sol',
    'salva-vidas', 'gaivota', 'estrela-do-mar', 'pegada na areia', 'pôr do sol',
    'coqueiro', 'areia', 'maré', 'isopor', 'mate gelado', 'biscoito de polvilho',
    'pipa', 'jangada', 'farol', 'duna', 'piscina natural', 'mergulho',
    'snorkel', 'pé de vento', 'toalha', 'sandália', 'sunga', 'maiô'] },
  { id: 'fundodomar', nome: 'Fundo do Mar', emoji: '🐠', words: [
    'polvo', 'tubarão', 'baleia', 'golfinho', 'água-viva', 'cavalo-marinho',
    'coral', 'anêmona', 'tartaruga marinha', 'arraia', 'enguia', 'siri',
    'camarão', 'lula', 'ostra', 'pérola', 'submarino', 'escafandro',
    'navio naufragado', 'baú do tesouro', 'âncora', 'rede de pesca', 'anzol',
    'bolha', 'alga', 'recife', 'peixe-palhaço', 'baiacu', 'peixe-espada',
    'estrela-do-mar', 'ouriço', 'foca', 'leão-marinho', 'pinguim', 'iceberg',
    'sereia', 'tridente', 'periscópio', 'sonar', 'plâncton', 'krill',
    'moreia', 'caranguejo-aranha', 'fosso oceânico'] },
  { id: 'festajunina', nome: 'Festa Junina', emoji: '🎉', words: [
    'fogueira', 'bandeirinha', 'quadrilha', 'chapéu de palha', 'pescaria',
    'pé de moleque', 'paçoca', 'canjica', 'pamonha', 'curau', 'quentão',
    'maçã do amor', 'algodão-doce', 'pipoca', 'milho cozido', 'bolo de fubá',
    'arraiá', 'sanfona', 'triângulo', 'zabumba', 'forró', 'casamento caipira',
    'noiva caipira', 'noivo caipira', 'padre', 'delegado', 'correio elegante',
    'barraca de tiro ao alvo', 'argola', 'boca do palhaço', 'cadeia',
    'fogos de artifício', 'balão', 'espantalho', 'vestido de chita',
    'trança', 'sardinha pintada', 'dente pintado', 'bigode pintado',
    'mastro', 'fita colorida', 'quermesse', 'boi-bumbá'] },
  { id: 'natal', nome: 'Natal', emoji: '🎄', words: [
    'árvore de natal', 'papai noel', 'rena', 'trenó', 'presente', 'laço',
    'meia de natal', 'guirlanda', 'sino', 'pisca-pisca', 'estrela do topo',
    'bola de natal', 'boneco de neve', 'floco de neve', 'lareira', 'vela',
    'panetone', 'chester', 'ceia', 'amigo secreto', 'cartão de natal',
    'presépio', 'anjo', 'ovelha', 'manjedoura', 'rei mago', 'camelo',
    'duende', 'oficina do papai noel', 'chaminé', 'saco de presentes',
    'biscoito de gengibre', 'bengala doce', 'azevinho', 'coroa de flores',
    'neve', 'lua cheia', 'canção de natal', 'coral', 'espírito natalino',
    'papel de presente', 'fita', 'etiqueta'] },
  { id: 'terror', nome: 'Terror', emoji: '👻', words: [
    'fantasma', 'vampiro', 'lobisomem', 'múmia', 'zumbi', 'bruxa', 'caldeirão',
    'vassoura', 'gato preto', 'morcego', 'aranha', 'teia de aranha', 'caveira',
    'esqueleto', 'lápide', 'cemitério', 'castelo assombrado', 'porta rangendo',
    'corrente', 'abóbora', 'vela derretida', 'espelho quebrado', 'sótão',
    'porão', 'grito', 'sombra', 'olho na fechadura', 'boneca assustadora',
    'palhaço assustador', 'máscara', 'motosserra', 'lua cheia', 'névoa',
    'coruja', 'corvo', 'cruz', 'alho', 'estaca', 'caixão', 'sarcófago',
    'poção', 'livro de feitiços', 'bola de cristal', 'tabuleiro ouija'] },
  { id: 'faroeste', nome: 'Faroeste', emoji: '🤠', words: [
    'xerife', 'estrela de xerife', 'chapéu de cowboy', 'bota com espora',
    'revólver', 'coldre', 'duelo', 'cavalo', 'sela', 'laço', 'boi', 'búfalo',
    'saloon', 'porta vaivém', 'balcão', 'piano', 'baralho', 'pôquer',
    'cadeia', 'forca', 'cartaz de procurado', 'recompensa', 'diligência',
    'trem a vapor', 'trilho', 'assalto ao trem', 'banco', 'cofre', 'dinamite',
    'mina de ouro', 'picareta', 'bateia', 'pepita', 'deserto', 'cacto',
    'planta rolante', 'urubu', 'cobra cascavel', 'crânio de boi', 'canyon',
    'poço', 'moinho de vento', 'cantil', 'lenço no pescoço', 'bandido mascarado'] },
  { id: 'construcao', nome: 'Construção', emoji: '🔨', words: [
    'martelo', 'prego', 'parafuso', 'chave de fenda', 'chave inglesa', 'alicate',
    'serrote', 'furadeira', 'trena', 'nível', 'esquadro', 'lixa', 'espátula',
    'pincel', 'rolo de pintura', 'lata de tinta', 'escada', 'andaime',
    'capacete', 'colete refletivo', 'luva', 'óculos de proteção', 'bota',
    'carrinho de mão', 'pá', 'enxada', 'picareta', 'betoneira', 'cimento',
  ...
  { id: 'detetive', nome: 'Detetive', emoji: '🔍', words: [
    'lupa', 'impressão digital', 'pegada', 'pista', 'suspeito', 'álibi',
    'interrogatório', 'delegacia', 'algema', 'distintivo', 'cassetete',
    'viatura', 'sirene', 'fita de isolamento', 'giz no chão', 'corpo de delito',
    'arma do crime', 'cofre arrombado', 'chave falsa', 'gazua', 'disfarce',
    'bigode falso', 'capa de chuva', 'chapéu fedora', 'cachimbo', 'caderneta',
    'mural de pistas', 'linha vermelha', 'retrato falado', 'câmera de segurança',
    'escuta', 'binóculo', 'lanterna', 'cofre', 'assalto', 'roubo', 'sequestro',
    'resgate', 'testemunha', 'julgamento', 'juiz', 'advogado', 'júri',
    'confissão', 'caso encerrado'] },
];
...
const COR_TEMA = {
  ...
  fazenda: UP.lime,    espaco: UP.cyan,     piratas: UP.orange, dinossauros: UP.lime,
  circo: UP.pink,      superherois: UP.red,
  praia: UP.cyan,      fundodomar: UP.cyan, festajunina: UP.yellow, natal: UP.red,
  terror: UP.purple,   faroeste: UP.orange, construcao: UP.yellow,  detetive: UP.purple,
};
