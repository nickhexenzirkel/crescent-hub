...
const NAV=[
  ...
  {id:'unikogym',   label:'Uniko Gym',      icon:<I><rect x="2" y="8" width="4" height="8" rx="1.3"/><rect x="18" y="8" width="4" height="8" rx="1.3"/><line x1="6" y1="12" x2="18" y2="12"/></I>},
...
const TopBar = ({tab,onBack}) => {
  ...
  const nm={inicio:'Início',financeiro:'Financeiro',dados:'Seus Dados',horas:'Banco de Horas',
    ...
    quizmm:'Quiz do M&M',unikostop:'Uniko Stop!',unikofaster:'Uniko Speed',unikosuspect:'Uniko Suspect',unikogym:'Uniko Gym'};
