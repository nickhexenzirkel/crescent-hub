...
const NAV=[
  ...
  {id:'unikofaster',label:'Uniko Speed',   icon:<img src="/uniko-speed.png" alt="" width="22" height="22" style={{display:'block',objectFit:'contain',filter:'drop-shadow(0 1px 3px rgba(0,0,0,.4))'}}/>},
];
...
const TopBar = ({tab,onBack}) => {
  ...
  const nm={inicio:'Início',financeiro:'Financeiro',dados:'Seus Dados',horas:'Banco de Horas',
    ...
    quizmm:'Quiz do M&M',unikostop:'Uniko Stop!',unikofaster:'Uniko Speed'};
