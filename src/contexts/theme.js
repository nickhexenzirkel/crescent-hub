...
const THEMES = {
  ...
  orgulho: {
    ...
    page:'#FDFCFF', gold:'#9A1880', goldL:'#C030A0', goldV:'#FF80D0',
    goldGl:'rgba(154,24,128,0.09)', goldLine:'#B020A0',
    blue:'#9A1880', blueL:'#C030A0', blueGl:'rgba(154,24,128,0.08)',
    blobBase:'#F8F8FC', blobVeil:'rgba(255,255,255,0.15)',
    b1:'rgba(255,15,15,0.82)',  b2:'rgba(255,125,0,0.76)',
    b3:'rgba(255,222,0,0.72)',  b4:'rgba(0,185,58,0.74)',
    b5:'rgba(0,80,242,0.70)',   b6:'rgba(112,0,205,0.80)',
    b7:'rgba(200,0,115,0.72)',
    ...
    sidebarBg:'rgba(253,250,255,0.97)', topbarBg:'rgba(253,250,255,0.94)',
  ...
  orgulhoDark: {
    ...
    page:'#080810', surface:'#120820', border:'rgba(255,255,255,0.08)', divider:'rgba(255,255,255,0.05)',
    surfaceInput:'rgba(255,255,255,0.06)', inputFocus:'rgba(255,255,255,0.10)',
    ...
    blobBase:'#060608', blobVeil:'rgba(0,0,0,0.22)',
    b1:'rgba(255,25,25,0.92)',  b2:'rgba(255,138,0,0.88)',
    b3:'rgba(255,228,0,0.82)',  b4:'rgba(0,210,68,0.88)',
    b5:'rgba(0,75,255,0.85)',   b6:'rgba(128,0,220,0.92)',
    b7:'rgba(220,0,132,0.82)',
    ...
    sidebarBg:'rgba(6,5,12,0.98)', topbarBg:'rgba(6,5,12,0.95)',
