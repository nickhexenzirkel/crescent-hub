...
const THEMES = {
  ...
  orgulho: {
    ...
    page:'#FDF4FF', gold:'#9A1880', goldL:'#C030A0', goldV:'#FF80D0',
    goldGl:'rgba(154,24,128,0.09)', goldLine:'#B020A0',
    blue:'#9A1880', blueL:'#C030A0', blueGl:'rgba(154,24,128,0.08)',
    blobBase:'#F8EAFF', blobVeil:'rgba(248,234,255,0.42)',
    b1:'rgba(220,30,30,0.70)',  b2:'rgba(255,120,0,0.60)',
    b3:'rgba(255,210,0,0.55)',  b4:'rgba(0,160,50,0.58)',
    b5:'rgba(0,80,220,0.55)',   b6:'rgba(140,0,200,0.62)',
    b7:'rgba(200,0,120,0.50)',
    ...
    sidebarBg:'rgba(253,246,255,0.97)', topbarBg:'rgba(253,246,255,0.94)',
  ...
  orgulhoDark: {
    ...
    page:'#0D0510', surface:'#1A0A20', border:'rgba(255,255,255,0.08)', divider:'rgba(255,255,255,0.05)',
    surfaceInput:'rgba(255,255,255,0.06)', inputFocus:'rgba(255,255,255,0.10)',
    ...
    blobBase:'#080310', blobVeil:'rgba(8,3,16,0.35)',
    b1:'rgba(200,20,20,0.88)',  b2:'rgba(220,100,0,0.82)',
    b3:'rgba(210,175,0,0.68)',  b4:'rgba(0,140,40,0.80)',
    b5:'rgba(0,60,200,0.75)',   b6:'rgba(120,0,180,0.88)',
    b7:'rgba(180,0,100,0.68)',
    ...
    sidebarBg:'rgba(8,3,12,0.98)', topbarBg:'rgba(8,3,12,0.95)',
