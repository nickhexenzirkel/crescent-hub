...
create policy "uniko safer arquivos read" on storage.objects
  for select using (bucket_id = 'uniko-safer' and is_admin_ou_moderador());

create policy "uniko safer arquivos insert" on storage.objects
  for insert with check (bucket_id = 'uniko-safer' and is_admin_ou_moderador());

create policy "uniko safer arquivos delete" on storage.objects
  for delete using (bucket_id = 'uniko-safer' and is_admin_ou_moderador());
